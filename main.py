...
from bonys import router as bonus_router
...
async def main():
    ...
    dp.include_routers(
        admin_router, kazna.router, balance_router, transfer_router,
        bonus_router, donate_router, start_router, roulette_router,
        mines_router, ctra.router, promo_router, setns.router,
        help.router, top.router, tur_router, kalculator.router,
    )
