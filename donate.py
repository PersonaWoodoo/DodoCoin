...
DONATE_PACKS = {
    ...
    "p_250":  {"stars": 500,  "amount": 1150000, "bonus": "+20%"},
    "p_500":  {"stars": 1000, "amount": 2300000, "bonus": "+25%"},
    "p_1000": {"stars": 2500, "amount": 6250000, "bonus": "+30%"},
}
...
@router.callback_query(F.data.startswith("pay:dc:"))
async def create_invoice(call: CallbackQuery, bot: Bot):
    pack_id = call.data.split("pay:dc:")[1]
    ...
    title = "💳 Пополнение dC"
    description = f"Начисление {fmt_amount} dC на ваш игровой аккаунт."
    payload = f"dc:{amount}:{stars}"
...
async def on_successful_payment(message: Message):
    ...
    await message.answer(
        ...
        f"💰 На ваш баланс зачислено: <b>{fmt_amount} dC</b>\n"
